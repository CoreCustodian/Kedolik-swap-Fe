        ...
        <div className="bg-dark-900 rounded-2xl border border-white/20 shadow-2xl w-full max-w-md max-h-[85vh] sm:max-h-[90vh] flex flex-col overflow-hidden animate-scale-in">
            ...
            <div>
              ...
              {jupiterEnabled && (
                <p className="text-[10px] sm:text-xs text-gray-500 mt-0.5">
                  Kedolik pools + Jupiter token search
                </p>
              )}
            </div>
            <button
          ...
          <div className="p-3 sm:p-4 border-b border-white/10">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder={jupiterEnabled ? 'Search any Solana token via Jupiter' : 'Search name, symbol or paste address'}
                value={searchQuery}
            ...
            {isSearching ? (
              ...
              <div className="divide-y divide-white/5">
                {filteredTokens.map((token) => (
                  <div key={token.mint.toString()} className="flex items-center gap-2 group hover:bg-white/5 transition-colors">
                    <button
